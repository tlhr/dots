...
;; URL: https://github.com/tlhr/flat
...
(defgroup flat-theme nil
  "Options for the flat theme."
  :group 'faces)

(defcustom flat-sans-font "Whitney"
  "Sans Font to use."
  :group 'flat-theme
  :type 'string)

(defcustom flat-serif-font "Palatino"
  "Serif Font to use."
  :group 'flat-theme
  :type 'string)

(defcustom flat-tooltip-font-size 140
  "Font size in 1/10 pts to use for tooltips."
  :group 'flat-theme
  :type 'integer)

(defcustom flat-modeline-font-size 160
  "Font size in 1/10 pts to use for the modeline."
  :group 'flat-theme
  :type 'integer)

(defcustom flat-speedbar-font-size 160
  "Font size in 1/10 pts to use for the speedbar."
  :group 'flat-theme
  :type 'integer)

(defcustom flat-use-org-sans nil
...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(tooltip ((,class (:family ,flat-sans-font :height ,flat-tooltip-font-size :foreground ,bg1 :background ,fg2))))
   ;; Ac
   ...
   ;; Speedbar
   `(speedbar-button-face ((,class (:family ,flat-sans-font :height ,flat-speedbar-font-size :foreground ,type))))
   `(speedbar-directory-face ((,class (:family ,flat-sans-font :height ,flat-speedbar-font-size :foreground ,keyword))))
   `(speedbar-file-face ((,class (:family ,flat-sans-font :height ,flat-speedbar-font-size :foreground ,fg1))))
   `(speedbar-highlight-face ((,class (:family ,flat-sans-font :height ,flat-speedbar-font-size :foreground ,var :bold t))))
   `(speedbar-selected-face ((,class (:family ,flat-sans-font :height ,flat-speedbar-font-size :foreground ,var))))
   `(speedbar-tag-face ((,class (:family ,flat-sans-font :height ,flat-speedbar-font-size :foreground ,func))))
   `(speedbar-separator-face ((,class (:family ,flat-sans-font :height ,flat-speedbar-font-size :foreground ,var :bold t))))
   ;; Emacs Ipython Notebook
   `(ein:cell-input-prompt ((,class (:foreground ,func :background ,bg1 :bold t))))
   ...
   ;; mode-line
   `(mode-line ((,class (
                         ;; :family ,flat-sans-font :height ,flat-modeline-font-size
                                 :foreground nil :background ,bg3))))
   ...
   `(org-level-1 ((,class (:family ,(if flat-use-org-sans flat-sans-font) :bold t :foreground ,fg1 :height ,(if flat-use-org-sans 1.6 1.0)))))
   `(org-level-2 ((,class (:family ,(if flat-use-org-sans flat-sans-font) :bold ,(if flat-use-org-sans nil t) :foreground ,fg1 :height ,(if flat-use-org-sans 1.4 1.0)))))
   ...
   `(org-special-keyword ((,class (:foreground ,keyword :bold t))))
   `(org-table ((,class (:foreground ,fg2))))
   `(org-tag ((,class (:foreground ,rainbow-5 :bold t))))
   `(org-todo ((,class (:foreground ,rainbow-4 :bold t))))
