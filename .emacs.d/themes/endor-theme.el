...
;; URL: https://github.com/tlhr/endor
...
(defgroup endor-theme nil
  "Options for the endor theme."
  :group 'faces)

(defcustom endor-sans-font "DIN"
  "Sans Font to use."
  :group 'endor-theme
  :type 'string)

(defcustom endor-serif-font "Palatino"
  "Serif Font to use."
  :group 'endor-theme
  :type 'string)

(defcustom endor-tooltip-font-size 140
  "Font size in 1/10 pts to use for tooltips."
  :group 'endor-theme
  :type 'integer)

(defcustom endor-modeline-font-size 160
  "Font size in 1/10 pts to use for the modeline."
  :group 'endor-theme
  :type 'integer)

(defcustom endor-speedbar-font-size 160
  "Font size in 1/10 pts to use for the speedbar."
  :group 'endor-theme
  :type 'integer)

(defcustom endor-use-org-serif nil
...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(tooltip ((,class (:family ,endor-sans-font :height ,endor-tooltip-font-size :foreground ,bg1 :background ,fg2))))
   ;; Ac
   ...
   ;; Speedbar
   `(speedbar-button-face ((,class (:family ,endor-sans-font :height ,endor-speedbar-font-size :foreground ,type))))
   `(speedbar-directory-face ((,class (:family ,endor-sans-font :height ,endor-speedbar-font-size :foreground ,keyword))))
   `(speedbar-file-face ((,class (:family ,endor-sans-font :height ,endor-speedbar-font-size :foreground ,fg1))))
   `(speedbar-highlight-face ((,class (:family ,endor-sans-font :height ,endor-speedbar-font-size :foreground ,var :bold t))))
   `(speedbar-selected-face ((,class (:family ,endor-sans-font :height ,endor-speedbar-font-size :foreground ,var))))
   `(speedbar-tag-face ((,class (:family ,endor-sans-font :height ,endor-speedbar-font-size :foreground ,func))))
   `(speedbar-separator-face ((,class (:family ,endor-sans-font :height ,endor-speedbar-font-size :foreground ,var :bold t))))
   ...
   `(font-lock-warning-face ((,class (:foreground ,warning :bold t :background ,bg1))))
   ...
   ;; ocaml
   `(tuareg-font-lock-governing-face ((,class (:foreground ,builtin :bold t))))
   `(tuareg-font-lock-operator-face ((,class (:foreground ,builtin))))
   ;; auto-complete
   `(ac-completion-face ((,class (:underline t :foreground ,keyword))))
   ;; rtags
   `(rtags-skippedline ((,class (:background ,bg2))))
   ;; company
   ...
   `(company-scrollbar-fg ((,class (:background ,fg4))))
   ...
   `(company-tooltip-selection ((,class (:foreground ,fg1 :background ,bg4))))
   ;; spaceline
   ...
   ;; diff-hl
   `(diff-hl-change ((,class (:foreground ,keyword :bold t))))
   `(diff-hl-delete ((,class (:foreground ,const :bold t))))
   `(diff-hl-insert ((,class (:foreground ,func :bold t))))
   ;; enh-ruby
   ...
   ;; mode-line
   `(mode-line ((,class (:family ,endor-sans-font :height ,endor-modeline-font-size :foreground nil :background ,bg3))))
   `(mode-line-inactive ((,class (:inherit mode-line :foreground ,bg4 :background ,bg2))))
   ...
   `(org-meta-line ((,class (:foreground ,comment :italic t))))
   `(org-block ((,class (:foreground ,rainbow-5))))
   `(org-block-begin-line ((,class (:foreground ,comment :background ,bg3 :italic t))))
   `(org-block-end-line ((,class (:foreground ,comment :background ,bg3 :italic t))))
   `(org-block-background ((,class (:background ,bg2))))
   ...
   `(org-done ((,class (:foreground ,func :bold t))))
   ...
   `(org-level-1 ((,class (:family ,(if endor-use-org-serif endor-serif-font) :bold ,(if endor-use-org-serif nil t) :foreground ,fg1 :height ,(if endor-use-org-serif 1.8 1.2)))))
   `(org-level-2 ((,class (:family ,(if endor-use-org-serif endor-serif-font) :bold ,(if endor-use-org-serif nil t) :foreground ,fg1 :height ,(if endor-use-org-serif 1.4 1.0)))))
   `(org-level-3 ((,class (:family ,(if endor-use-org-serif endor-serif-font) :bold ,(if endor-use-org-serif nil nil) :foreground ,fg1 :height ,(if endor-use-org-serif 1.0 1.0)))))
   `(org-level-4 ((,class (:family ,(if endor-use-org-serif endor-serif-font) :bold ,(if endor-use-org-serif nil nil) :foreground ,fg1 :height ,(if endor-use-org-serif 1.0 1.0)))))
   `(org-level-5 ((,class (:family ,(if endor-use-org-serif endor-serif-font) :bold ,(if endor-use-org-serif nil nil) :foreground ,fg1 :height ,(if endor-use-org-serif 1.0 1.0)))))
   `(org-level-6 ((,class (:family ,(if endor-use-org-serif endor-serif-font) :bold ,(if endor-use-org-serif nil nil) :foreground ,fg1 :height ,(if endor-use-org-serif 1.0 1.0)))))
   `(org-level-7 ((,class (:family ,(if endor-use-org-serif endor-serif-font) :bold ,(if endor-use-org-serif nil nil) :foreground ,fg1 :height ,(if endor-use-org-serif 1.0 1.0)))))
   `(org-level-8 ((,class (:family ,(if endor-use-org-serif endor-serif-font) :bold ,(if endor-use-org-serif nil nil) :foreground ,fg1 :height ,(if endor-use-org-serif 1.0 1.0)))))
   `(org-link ((,class (:foreground ,rainbow-2 :underline t))))
   `(org-priority ((,class (:foreground ,rainbow-2))))
   `(org-scheduled ((,class (:foreground ,rainbow-6 :bold t))))
   `(org-scheduled-previously ((,class (:foreground ,rainbow-3 :bold t))))
