;;; mistral-theme.el --- Mistral Theme
...
;; URL: https://github.com/tlhr/mistral
...
(defgroup mistral-theme nil
  "Options for the mistral theme."
  :group 'faces)

(defcustom mistral-sans-font "Whitney"
  "Sans Font to use."
  :group 'mistral-theme
  :type 'string)

(defcustom mistral-serif-font "Palatino"
  "Serif Font to use."
  :group 'mistral-theme
  :type 'string)

(defcustom mistral-tooltip-font-size 140
  "Font size in 1/10 pts to use for tooltips."
  :group 'mistral-theme
  :type 'integer)

(defcustom mistral-modeline-font-size 160
  "Font size in 1/10 pts to use for the modeline."
  :group 'mistral-theme
  :type 'integer)

(defcustom mistral-speedbar-font-size 160
  "Font size in 1/10 pts to use for the speedbar."
  :group 'mistral-theme
  :type 'integer)

(defcustom mistral-use-org-sans t
...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(line-number-current-line ((,class (:foreground ,key2 :background ,bg2 :bold t :underline nil))))
   ;; flycheck
   ...
   `(tooltip ((,class (:family ,mistral-sans-font :height ,mistral-tooltip-font-size :foreground ,bg1 :background ,fg2))))
   ;; Ac
   ...
   ;; Speedbar
   `(speedbar-button-face ((,class (:family ,mistral-sans-font :height ,mistral-speedbar-font-size :foreground ,type))))
   `(speedbar-directory-face ((,class (:family ,mistral-sans-font :height ,mistral-speedbar-font-size :foreground ,keyword))))
   `(speedbar-file-face ((,class (:family ,mistral-sans-font :height ,mistral-speedbar-font-size :foreground ,fg1))))
   `(speedbar-highlight-face ((,class (:family ,mistral-sans-font :height ,mistral-speedbar-font-size :foreground ,var :bold t))))
   `(speedbar-selected-face ((,class (:family ,mistral-sans-font :height ,mistral-speedbar-font-size :foreground ,var))))
   `(speedbar-tag-face ((,class (:family ,mistral-sans-font :height ,mistral-speedbar-font-size :foreground ,func))))
   `(speedbar-separator-face ((,class (:family ,mistral-sans-font :height ,mistral-speedbar-font-size :foreground ,var :bold t))))
   ...
   `(diff-hl-insert ((,class (:foreground ,str :bold t))))
   ;; enh-ruby
   ...
   ;; mode-line
   `(mode-line ((,class (:family ,mistral-sans-font :height ,mistral-modeline-font-size :foreground nil :background ,bg2 :box (:line-width 1 :color ,fg3)))))
   `(mode-line-inactive ((,class (:inherit mode-line :foreground ,bg4 :background ,fg4 :box (:line-width 1 :color ,fg4)))))
   `(mode-line-buffer-id ((,class (:foreground ,key2 :background nil))))
   ...
   `(org-done ((,class (:foreground ,str :bold t))))
   ...
   `(org-level-1 ((,class (:family ,(if mistral-use-org-sans mistral-sans-font) :bold t :foreground ,fg1 :height ,(if mistral-use-org-sans 1.6 1.2)))))
   `(org-level-2 ((,class (:family ,(if mistral-use-org-sans mistral-sans-font) :bold ,(if mistral-use-org-sans nil t) :foreground ,fg1 :height ,(if mistral-use-org-sans 1.4 1.0)))))
   ...
   `(org-scheduled ((,class (:foreground ,keyword :bold t))))
   ...
   `(org-todo ((,class (:foreground ,var :bold t))))
...
(provide-theme 'mistral)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; mistral-theme.el ends here
