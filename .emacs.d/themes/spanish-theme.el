;;; spanish-theme.el --- Spanish Theme
...
;; URL: https://github.com/tlhr/spanish
...
(defgroup spanish-theme nil
  "Options for the spanish theme."
  :group 'faces)

(defcustom spanish-sans-font "Whitney"
  "Sans Font to use."
  :group 'spanish-theme
  :type 'string)

(defcustom spanish-serif-font "Palatino"
  "Serif Font to use."
  :group 'spanish-theme
  :type 'string)

(defcustom spanish-tooltip-font-size 140
  "Font size in 1/10 pts to use for tooltips."
  :group 'spanish-theme
  :type 'integer)

(defcustom spanish-modeline-font-size 160
  "Font size in 1/10 pts to use for the modeline."
  :group 'spanish-theme
  :type 'integer)

(defcustom spanish-speedbar-font-size 160
  "Font size in 1/10 pts to use for the speedbar."
  :group 'spanish-theme
  :type 'integer)

(defcustom spanish-use-org-sans t
...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(tooltip ((,class (:family ,spanish-sans-font :height ,spanish-tooltip-font-size :foreground ,bg1 :background ,fg2))))
   ;; Ac
   ...
   ;; Speedbar
   `(speedbar-button-face ((,class (:family ,spanish-sans-font :height ,spanish-speedbar-font-size :foreground ,type))))
   `(speedbar-directory-face ((,class (:family ,spanish-sans-font :height ,spanish-speedbar-font-size :foreground ,keyword))))
   `(speedbar-file-face ((,class (:family ,spanish-sans-font :height ,spanish-speedbar-font-size :foreground ,fg1))))
   `(speedbar-highlight-face ((,class (:family ,spanish-sans-font :height ,spanish-speedbar-font-size :foreground ,var :bold t))))
   `(speedbar-selected-face ((,class (:family ,spanish-sans-font :height ,spanish-speedbar-font-size :foreground ,var))))
   `(speedbar-tag-face ((,class (:family ,spanish-sans-font :height ,spanish-speedbar-font-size :foreground ,func))))
   `(speedbar-separator-face ((,class (:family ,spanish-sans-font :height ,spanish-speedbar-font-size :foreground ,var :bold t))))
   ...
   ;; mode-line
   `(mode-line ((,class (:family ,spanish-sans-font :height ,spanish-modeline-font-size :foreground nil :background ,bg3 :box (:line-width 3 :color ,bg3)))))
   `(mode-line-inactive ((,class (:inherit mode-line :foreground ,fg4 :background ,bg2 :box (:line-width 3 :color ,bg2)))))
   ...
   `(org-document-info ((,class (:foreground ,rainbow-1))))
   `(org-document-info-keyword ((,class (:foreground ,comment :italic t :bold t))))
   `(org-document-title ((,class (:weight bold :foreground ,rainbow-8 :height 1.44))))
   `(org-done ((,class (:foreground ,rainbow-8 :bold t))))
   ...
   `(org-level-1 ((,class (:family ,(if spanish-use-org-sans spanish-sans-font) :bold t :foreground ,fg1 :height ,(if spanish-use-org-sans 1.6 1.2)))))
   `(org-level-2 ((,class (:family ,(if spanish-use-org-sans spanish-sans-font) :bold ,(if spanish-use-org-sans nil t) :foreground ,fg1 :height ,(if spanish-use-org-sans 1.4 1.0)))))
   ...
   `(org-scheduled ((,class (:foreground ,rainbow-3 :bold t))))
   `(org-scheduled-previously ((,class (:foreground ,rainbow-7))))
   `(org-scheduled-today ((,class (:foreground ,rainbow-6))))
   `(org-sexp-date ((,class (:foreground ,fg4))))
   `(org-special-keyword ((,class (:foreground ,rainbow-6 :bold t))))
   `(org-table ((,class (:foreground ,fg2))))
   `(org-tag ((,class (:foreground ,rainbow-5 :bold t))))
   `(org-todo ((,class (:foreground ,rainbow-8 :bold t))))
...
(provide-theme 'spanish)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; spanish-theme.el ends here
